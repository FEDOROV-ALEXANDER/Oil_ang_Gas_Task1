...
- **Расстояние между скважинами**: 1500-2000 метров.
...
2. **`solve.py`**: Модуль, содержащий функции для решения уравнения пьезопроводности методом конечных объёмов. Включает в себя функции для применения граничных условий и явного метода решения.
...
- **Скважины**:
  - Скважина 1: `(525, 400)`, дебит `1100 м3/сут`
  - Скважина 2: `(2000, 1500)`, дебит `1000 м3/сут`
  - Скважина 3: `(600, 1410)`, дебит `-1000 м3/сут`
  - Скважина 4: `(2250, 2200)`, дебит `-800 м3/сут`

- **Параметры пласта**:
  - Проницаемость: `100 * 10e-16 м2`
